                    ...
                    @forelse ($articles as $article)
                        <div class="articles__card">
                            <div class="articles__icon">
                                <svg>
                                    <use href="#icon-pdf" width="60" height="60" fill=""></use>
                                </svg> 
                            </div>
                            <div class="articles__card-title-row">
                                <a href="/storage/docs/articles/{{ $article->doc }}" class="articles__card-link" target="_blank">
                                    {{ $article->title }}
                                </a> (Tr)
                            </div>
                        </div>
