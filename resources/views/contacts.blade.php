                ...
                <div class="contacs__dir">
                    ...
                    <div class="contacs__dir-content">
                        <ul class="contacs__list contacs__list--email">
                            <li><a href="mailto:{{ $mdsettings['email1'] }}" class="contacts__email">{{ $mdsettings['email1'] }}</a></li>
                            <li><a href="mailto:{{ $mdsettings['email1'] }}" class="contacts__email">{{ $mdsettings['email2'] }}</a></li>                        
                        </ul>
                    </div>
                </div>
                ...
                <div class="contacs__dir">
                    ...
                    <div class="contacs__dir-content">
                        <ul class="contacs__list contacs__list--social">
                            <li>Linkedin: <a href="{{ $mdsettings['linkedin1'] }}" class="contacts__email" target="_blank">Orga Ki̇mya Mühendi̇sli̇k</a></li>
                            <li>Linkedin: <a href="{{ $mdsettings['linkedin2'] }}" class="contacts__email" target="_blank">Kadir Kutay Çalış</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="contacs__address-col contacs__address-col--text">
                        <div class="contacs__dir">
                            ...
                            <address class="contacs__dir-content">
                                <p class="contacs__address-city">{{ $mdsettings['city'] }}, {{ $mdsettings['district'] }}</p>
                                <div class="contacs__address-list">
                                    <div class="contacs__address-item">
                                        ...
                                        <div class="contacs__address-text"><a href="{{ $mdsettings['gmaplink1'] }}" target="_blank">{{ __('View on google map') }}</a></div>
                                    </div>
                                    <div class="contacs__address-item">
                                        <div class="contacs__address-title">DAP Royal Center</div>
                                        <div class="contacs__address-text">{{ $mdsettings['address2'] }}</div>
                                        <div class="contacs__address-text"><a href="{{ $mdsettings['gmaplink2'] }}" target="_blank">{{ __('View on google map') }}</a></div>
                                    </div>
                                </div>
                            </address>
                        </div>                        
